// src/app/opportunities/internships/page.tsx
...
import { opportunityService, InternshipListParams } from '@/lib/api/services/opportunity.service';
  ...
  const fetchInternships = useCallback(async () => {
    try {
      ...
      const params: InternshipListParams = {
        ...
        isPpo: selectedFilters.isPpo.includes('true') ? true : undefined,
      };

      const response = await opportunityService.listInternships(params);
      setData(response);
    } catch (error) {
    ...
    <div className="container mx-auto px-4 py-8 lg:py-12">
      <div className="mb-10">
        ...
        <p className="text-muted-foreground">
          Kickstart your career with meaningful internship programs.
        </p>
      </div>
      ...
      <div className="grid gap-8 lg:grid-cols-[280px_1fr]">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between text-sm">
            <p className="text-muted-foreground">
              Showing <span className="font-medium text-foreground">{data?.meta.total || 0}</span> internships
            </p>
          </div>
