// src/app/institute-admin/events/jobs/new/page.tsx
...
export default function CreateJobPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: 'Error', description: 'Failed to create job. Please check all fields.', variant: 'destructive' });
    } finally {
      setSubmitting(false);
    }
  };
    ...
    >
      ...
      <div className="space-y-3">
        ...
        <p className="text-base text-muted-foreground">
          Define a high-impact role and attract top talent from the ecosystem.
        </p>
      </div>
