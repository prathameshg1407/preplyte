...
import { Loader2, Eye, EyeOff, Check, X, AlertCircle, Mail, Lock, User, CheckCircle } from 'lucide-react';
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className={cn(
                ...
                emailVerified && 'border-emerald-500/50 bg-emerald-50 dark:bg-emerald-950/20'
              )}
              {...register('email')}
            />
            {emailVerified && (
          ...
          {!emailVerified && (
            <Button
              ...
              disabled={sendingOTP || !email || isDisabled}
              variant="outline"
