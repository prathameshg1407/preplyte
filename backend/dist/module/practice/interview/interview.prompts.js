...
exports.buildInterviewerSystemPrompt = buildInterviewerSystemPrompt;
...
exports.buildClosingPrompt = buildClosingPrompt;
exports.buildTopicTransitionPrompt = buildTopicTransitionPrompt;
// =====================================================
// RESUME PARSING PROMPT
// =====================================================
exports.RESUME_PARSING_PROMPT = `You are an expert resume parser. Extract structured information from the resume text provided.
...
// =====================================================
function buildInterviewerSystemPrompt(resume, profile, difficulty, jobTitle, companyName, focusAreas) {
...
function getDifficultyExpectation(difficulty) {
    const expectations = {
...
// =====================================================
function buildConversationContext(history, questionsAsked, currentTopic, followUpDepth) {
...
// =====================================================
function buildOpeningPrompt(candidateName, jobTitle) {
...
// =====================================================
function buildFollowUpPrompt(previousQuestion, candidateAnswer, category) {
...
// =====================================================
function buildScoringPrompt(question, answer, category, difficulty, expectedTopics) {
...
// =====================================================
function buildFeedbackPrompt(resume, jobTitle, difficulty, responses) {
...
// =====================================================
function buildClosingPrompt(candidateName) {
...
// =====================================================
function buildTopicTransitionPrompt(currentTopic, nextCategory, candidateSkills) {
