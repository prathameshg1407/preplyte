...
export const INTERVIEW_SESSION_CONFIG = {
  MIN_QUESTIONS: 5,
  MAX_QUESTIONS: 15,
...
export const AI_CONFIG = {
  ...
  // Use same 70B model for question generation to avoid thinking text leaks from smaller models
...
export const CACHE_KEYS = {
  ...
  userSessions: (userId: string) => `interview:user:${userId}:sessions`,
  activeSession: (userId: string) => `interview:user:${userId}:active`,
