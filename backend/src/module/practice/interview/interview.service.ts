...
class InterviewService {
  ...
  async startSession(
    userId: string,
    sessionId: string
  ): Promise<{ session: InterviewSessionResponse; openingMessage: string | null }> {
    ...
    logger.info('[InterviewService] Session started (opening will be generated via WebSocket)', { 
      sessionId 
    });
