...
-- CreateTable
CREATE TABLE "individual_mock_drives" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "individual_mock_drives_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "individual_mock_drive_modules" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "individual_mock_drive_modules_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "individual_mock_drive_attempts" (
    "id" TEXT NOT NULL,
    "mockDriveId" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    ...
    CONSTRAINT "individual_mock_drive_attempts_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "individual_mock_drive_module_attempts" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "individual_mock_drive_module_attempts_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "individual_mock_drives_userId_idx" ON "individual_mock_drives"("userId");

-- CreateIndex
CREATE INDEX "individual_mock_drive_modules_mockDriveId_idx" ON "individual_mock_drive_modules"("mockDriveId");

-- CreateIndex
CREATE UNIQUE INDEX "individual_mock_drive_modules_mockDriveId_order_key" ON "individual_mock_drive_modules"("mockDriveId", "order");

-- CreateIndex
CREATE INDEX "individual_mock_drive_attempts_mockDriveId_idx" ON "individual_mock_drive_attempts"("mockDriveId");

-- CreateIndex
CREATE INDEX "individual_mock_drive_attempts_userId_idx" ON "individual_mock_drive_attempts"("userId");

-- CreateIndex
CREATE INDEX "individual_mock_drive_module_attempts_attemptId_idx" ON "individual_mock_drive_module_attempts"("attemptId");

-- CreateIndex
CREATE INDEX "individual_mock_drive_module_attempts_moduleId_idx" ON "individual_mock_drive_module_attempts"("moduleId");

-- CreateIndex
CREATE UNIQUE INDEX "individual_mock_drive_module_attempts_attemptId_moduleId_key" ON "individual_mock_drive_module_attempts"("attemptId", "moduleId");
...
-- AddForeignKey
ALTER TABLE "individual_mock_drives" ADD CONSTRAINT "individual_mock_drives_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "individual_mock_drive_modules" ADD CONSTRAINT "individual_mock_drive_modules_mockDriveId_fkey" FOREIGN KEY ("mockDriveId") REFERENCES "individual_mock_drives"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "individual_mock_drive_attempts" ADD CONSTRAINT "individual_mock_drive_attempts_mockDriveId_fkey" FOREIGN KEY ("mockDriveId") REFERENCES "individual_mock_drives"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "individual_mock_drive_attempts" ADD CONSTRAINT "individual_mock_drive_attempts_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "individual_mock_drive_module_attempts" ADD CONSTRAINT "individual_mock_drive_module_attempts_attemptId_fkey" FOREIGN KEY ("attemptId") REFERENCES "individual_mock_drive_attempts"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "individual_mock_drive_module_attempts" ADD CONSTRAINT "individual_mock_drive_module_attempts_moduleId_fkey" FOREIGN KEY ("moduleId") REFERENCES "individual_mock_drive_modules"("id") ON DELETE CASCADE ON UPDATE CASCADE;
